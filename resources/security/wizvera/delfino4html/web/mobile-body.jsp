 ...
 -->        </div>
    ...
    <div id="certificateProviderList" class="g10_nav_shadow" style="display:none">
        ...
        <div id="g10_wrapper" class="g10_wrapper">
            <div id="g10_folding" class="g10_folding" role="button"></div>
    ...
    <div id="providerContent" style="display: none;">
        ...
        <fieldset id="providers-section" class="rightContent">
            <div id="vpcg_content" class="content">
                <span class="vpcg_btn_close" role="button" title="닫기" aria-label="닫기"></span>
                    ...
                    <form class='formData' name="vpcg_formLogin" onsubmit="return false;">
						...
						<div class="vpcg_terms">
							...
							<div class="service_terms">
								...
								<a class="service_terms_view termView" id="serviceView" target="_blank" role="button">보기></a>
							</div>
							<div class="privacy_terms">
								...
								<a class="privacy_terms_view termView" id="privacyView" target="_blank" role="button">보기></a>
							</div>
							<div class="info_terms">
								...
								<a class="info_terms_view termView" id="infoView" target="_blank" role="button">보기></a>
							</div>
							<div class="terms_view" aria-hidden="true"><iframe id="vpcg_terms_view"></iframe><span class="vpcg_btn_terms_close" role="button" title="약관보기 창 닫기" aria-label="약관보기 창 닫기"></span></div>
						</div>
        ...
        <div id="g10-intro-section" class="rightContent">
            ...
            <div class="intro_desc_box">
                ...
                <div class="intro_title_description"><span class="description">아래 리스트에서 인증수단을 선택하시면 인증입력 화면으로 이동합니다.</span></div>
            </div>
