...
<%
    ...
    System.out.println("service request:" + request.getParameter("service") + ", cmd:" + request.getParameter("cmd") + ", data:" + request.getParameter("data"));
    String text = Service.service(request);
    out.write(text);
