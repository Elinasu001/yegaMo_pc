    ...
    <div id="contentsWrap">
        ...
        <div class="contents default-wrap">
            <div class="error-wrap">
                <p>현재 해당 예가람저축은행 모집인상담사 사이트는 접속이 불가능합니다.<br>상담사 연락을 통해, 사이트 URL을 다시한번 확인해주세요<br>감사합니다.</p>
            </div>
        </div>
        <!-- //e:contents -->
    ...
    <div id="footerWrap" class="error-footer">
        <div class="footer default-wrap">
            ...
            <div class="footer-logo">
                <img src="<c:url value="/resources/normal/images/common/img_footer_logo_20191116.png"/>" alt="Yegaram Savings Bank 예가람저축은행">
            </div>
        </div>
    </div>
    <!-- //e:footerWrap -->
